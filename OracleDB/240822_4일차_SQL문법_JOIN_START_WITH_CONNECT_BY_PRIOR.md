# HR Schema table 관계
* 하나의 부서에는 여러 사원이 존재한다. (1:N)
* 한 명의 사원은 여러 명의 부하직원이 있다. (1:N)
* 한 명의 사원은 한 부서의 부서장이다. (1:1)
* 하나의 직무에는 여러 사원이 존재한다. (1:N)
* 한 명의 사원은 한 부서에서 한 직무로 근무했다. (1:N)
* 하나의 도시에는 여러 부서가 존재한다. (1:N)
* 하나의 국가에는 여러 도시가 존재한다. (1:N)
* 하나의 대륙에는 여러 국가가 존재한다. (1:N)
